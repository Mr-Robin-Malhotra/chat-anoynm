...
const E2EE = (() => {
  ...
  // Forget the derived key (on disconnect/leave) so a fresh key exchange runs
  // on the next connection. New keys are generated by init() again.
  function reset() { sharedKey = null; myKeys = null; }
  ...
  return { init, publicKeyJwk, deriveShared, ready, reset, encrypt, decrypt, b64, unb64 };
})();
